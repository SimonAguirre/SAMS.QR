...
public class RecyclerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if (pos == 0) outRect.top = 20 + 20;
        outRect.bottom = 20;
        if(sectionCallback.isSection(pos)) outRect.top = headerOffset+20;
    }
    ...
    {
        View view= LayoutInflater.from(context).inflate(R.layout.recyclerview_header,recyclerView,false);
        return view;
    }
